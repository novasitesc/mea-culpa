        ...
        {selectedItem ? (
          <div className="flex items-center justify-between bg-black/20 border border-gold/50 rounded-lg px-3 py-2 text-sm">
            <div className="flex items-center gap-2 min-w-0">
              {selectedItem.icon ? getIconForString(selectedItem.icon, "w-4 h-4 text-[#D4AF37] shrink-0") : null}
                    ...
                    return (
                      ...
                      >
                        <span className="inline-flex items-center gap-2">
                          {item.icon ? getIconForString(item.icon, "w-4 h-4 text-[#D4AF37] shrink-0") : null}
                          {item.name}
                        </span>
                        {quantitySuffix}
                      </button>
