-- ============================================================
-- MEA CULPA - Migracion 054
-- Corrige el bloqueo de compras en tienda: se bloquea con la
-- partida EN PROGRESO (media partida), no en el lobby. En el
-- lobby los jugadores deben poder abastecerse de raciones y
-- tienda de acampar antes de que inicie la expedicion.
-- ============================================================
